...
import static dev.pbroman.brat.core.util.ConditionResolver.BLANK;
import static dev.pbroman.brat.core.util.ConditionResolver.CONTAINS;
import static dev.pbroman.brat.core.util.ConditionResolver.EMPTY;
import static dev.pbroman.brat.core.util.ConditionResolver.ENDS_WITH;
import static dev.pbroman.brat.core.util.ConditionResolver.EQUALS;
import static dev.pbroman.brat.core.util.ConditionResolver.EQUALS_IGNORE_CASE;
import static dev.pbroman.brat.core.util.ConditionResolver.EQUAL_TO;
import static dev.pbroman.brat.core.util.ConditionResolver.GREATER_THAN;
import static dev.pbroman.brat.core.util.ConditionResolver.GREATER_THAN_OR_EQUAL;
import static dev.pbroman.brat.core.util.ConditionResolver.FALSE;
import static dev.pbroman.brat.core.util.ConditionResolver.TRUE;
import static dev.pbroman.brat.core.util.ConditionResolver.LESS_THAN;
import static dev.pbroman.brat.core.util.ConditionResolver.LESS_THAN_OR_EQUAL;
import static dev.pbroman.brat.core.util.ConditionResolver.MATCHES;
import static dev.pbroman.brat.core.util.ConditionResolver.NULL;
import static dev.pbroman.brat.core.util.ConditionResolver.STARTS_WITH;
